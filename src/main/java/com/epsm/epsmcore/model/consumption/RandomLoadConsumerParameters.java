...
public class RandomLoadConsumerParameters extends ConsumerParameters {
	...
	public RandomLoadConsumerParameters(long powerObjectId, int maxWorkDurationInSeconds, int maxPauseBetweenWorkInSeconds, float maxLoad, float degreeOnDependingOfFrequency) {
