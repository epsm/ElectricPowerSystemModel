...
public class MessageFilterTest {
	...
	private void createConsumerAndFilterForIt(){
		...
		object = new RandomLoadConsumer(simulation, timeService, dispatcher, consumerParameters);
		filter = new MessageFilter(object.getClass());
	}
	...
	private class UnsuportedPowerObject extends PowerObject{
		public UnsuportedPowerObject(Simulation simulation, TimeService timeService,
